...
namespace EvolutiveSystem
{
    public partial class FrmDbName : Form
    {
        ...
        public FrmDbName(string NewDbName )
        {
            InitializeComponent();
            this.newDbName = NewDbName;
        }
        private void FrmDbName_Load(object sender, EventArgs e)
        {
            txtDbName.Text = this.newDbName;
            txtDbName.SelectionStart = 0;
            txtDbName.SelectionLength = txtDbName.Text.Length;
        }
